# Join Form Country Field Mapping

Source: frontend mapping in app/static/js/doctor_registration.js (countryFields). It drives the label and placeholder for the doctor registration medical license and national ID fields.
